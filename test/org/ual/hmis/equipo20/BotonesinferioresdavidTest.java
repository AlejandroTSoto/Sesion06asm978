...
public class BotonesinferioresdavidTest {
  ...
  @Test
  public void botondavidrepo() {
    // Test name: boton-david-repo
  ...
  @Test
  public void botondavidhtml5() {
    // Test name: boton-david-html5
    // Step # | name | target | value
    // 1 | open | https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html | 
    driver.get("https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html");
    // 2 | setWindowSize | 1021x727 | 
  ...
  @Test
  public void botondavidgithub() {
    // Test name: boton-david-github
    // Step # | name | target | value
    // 1 | open | https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html | 
    driver.get("https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html");
    // 2 | setWindowSize | 1021x727 | 
    ...
    // 6 | assertText | css=.p-name | David Hernandez Carmona
    assertThat(driver.findElement(By.cssSelector(".p-name")).getText(), is("David Hernandez Carmona"));
  }
  @Test
  public void nobotondavidrepo() {
    // Test name: no-boton-david-repo
    // Step # | name | target | value
    // 1 | open | https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html | 
    driver.get("https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html");
    // 2 | setWindowSize | 1021x727 | 
  ...
  @Test
  public void nobotondavidhtml5() {
    // Test name: no-boton-david-html5
    // Step # | name | target | value
    // 1 | open | https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html | 
    driver.get("https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html");
    // 2 | setWindowSize | 1021x727 | 
  ...
  @Test
  public void nobotondavidgithub() {
    // Test name: no-boton-david-github
    // Step # | name | target | value
    // 1 | open | https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html | 
    driver.get("https://hmis2023-sesion04-freeweb.azurewebsites.net/index.html");
    // 2 | setWindowSize | 1021x727 | 
    ...
    // 5 | click | css=li:nth-child(1) > .icon | 
    driver.findElement(By.cssSelector("li:nth-child(1) > .icon")).click();
    // 6 | assertNotText | css=.p-name | David Hernandez Carmona
    assertThat(driver.findElement(By.cssSelector(".p-name")).getText(), is(not("David Hernandez Carmona")));
  }
}
